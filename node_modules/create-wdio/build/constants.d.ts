 ...
 */
export declare function buildDioxusBanner(driverProvider: DioxusDriverProviderChoice | undefined): string;
...
export declare enum DioxusDriverProviderChoice {
...
export declare function getResolvedPurpose(answers: Questionnair): "e2e" | "vscode" | "electron" | "tauri" | "dioxus" | "roku" | "component" | "macos";
...
export declare const QUESTIONNAIRE: ({
    ...
    name: string;
    message: string;
    choices: DioxusDriverProviderChoice[];
    when: (answers: Questionnair) => boolean;
    default?: undefined;
} | {
    type: string;
