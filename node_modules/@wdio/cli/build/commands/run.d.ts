...
export declare const cmdArgs: {
    ...
    readonly cpuProf: {
        readonly desc: "Enable Node.js CPU profiling for worker processes (--cpu-prof)";
        readonly type: "boolean";
    };
    readonly heapProf: {
        readonly desc: "Enable Node.js heap profiling for worker processes (--heap-prof)";
        readonly type: "boolean";
    };
};
export declare const builder: (yargs: Argv) => Argv<import("yargs").Omit<{}, "exclude" | "bail" | "updateSnapshots" | "framework" | "reporters" | "watch" | "shard" | "mochaOpts" | "jasmineOpts" | "cucumberOpts" | "cpuProf" | "heapProf" | "baseUrl" | "waitforTimeout" | "logLevel" | "hostname" | "port" | "path" | "user" | "key" | "coverage" | "headless" | "suite" | "spec" | "repeat"> & import("yargs").InferredOptionTypes<{
    readonly watch: {
        readonly desc: "Run WebdriverIO in watch mode";
        readonly type: "boolean";
    };
