...
export default class WebDriverInterception {
    ...
    static initiate(url: string | URLPattern, filterOptions: MockFilterOptions, browser: WebdriverIO.Browser): Promise<WebDriverInterception>;
    /**
    ...
    isSameDefinition(url: string | URLPattern, filterOptions?: MockFilterOptions): boolean;
